...
public class RequestJson {
        ...
        public static String calcAuthorization(String source, String secretId, String secretKey, String datetime)
            ...
            Key sKey;
            sKey = new SecretKeySpec(secretKey.getBytes("UTF-8"), mac.getAlgorithm());
            mac.init(sKey);
        ...
        public static String getResult(String isbn) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
            //云市场分配的密钥Id
            String secretId = "AKIDBZK0gsw6Pn0Opj84uu4ziSo94k7bI43eIv3Q";
            //云市场分配的密钥Key
            String secretKey = "Cae3375d0z9L3ZqdW1UIJL4D5DcN3t1Ksl1u0Dh2";
    ...
    public static Book parseJson_toBook(Context context, String text, String isbn) {
        ...
        try {
            ...
            new_book.setBookName(jsonDatas.getString("title"));
            new_book.setAuthor(jsonDatas.getString("author"));
            new_book.setPressName(jsonDatas.getString("publisher"));
            new_book.setPressTime(jsonDatas.getString("pubdate"));
            new_book.setISBN(jsonDatas.getString("isbn"));
            url=jsonDatas.getString("img");
            Bitmap bit=ImageManager.decodeSampledBitmapFromUrl(context, url);
            ImageManager.SaveImage(context,bit,new_book.getUuid());
            //Log.d("book message", jsonDatas.getString("title"));
...
//            public void run() {
//                try {
//                    bit=ImageManager.decodeSampledBitmapFromUrl(context, finalUrl);
//                    ImageManager.SaveImage(context,bit,new_book.getUuid());
